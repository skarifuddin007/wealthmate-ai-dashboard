        ...
        <TabsContent value="login">
          <form onSubmit={handleLogin}>
            ...
            <CardFooter className="flex flex-col space-y-4">
              <Button 
                type="submit" 
                className="w-full wealth-button" 
                disabled={loading}
              >
              ...
              <div className="relative w-full">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-wealth-primary/20"></div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 w-full">
                <Button variant="outline" type="button" className="glass-input">
          ...
          <form onSubmit={handleSignup}>
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <div className="mt-6 w-full">
                <Badge variant="outline" className="w-full py-1.5 justify-center bg-wealth-primary/5">
